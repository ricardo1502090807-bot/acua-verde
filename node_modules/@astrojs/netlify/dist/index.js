  ...
  return {
    ...
    hooks: {
        ...
        updateConfig({
          ...
          image: {
            service: {
              ...
              entrypoint: integrationConfig?.imageCDN === false || // In dev, if the vite plugin's image proxy isn't enabled, don't try to use the Netlify service since it won't work
              command === "dev" && vitePluginOptions?.images?.enabled === false ? void 0 : "@astrojs/netlify/image-service.js"
            }
          }
        });
      },
      ...
      "astro:config:done": async (params) => {
        ...
        const middlewareMode = integrationConfig?.middlewareMode ?? (integrationConfig?.edgeMiddleware ? "edge" : "classic");
